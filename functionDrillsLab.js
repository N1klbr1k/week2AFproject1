...
let newString = String(name);
console.log('Hello, ' + newString);
}

//console.log(greeting('jerry'));
...
// arrow
// declaration
//expression this one is the answer but i dont want to uncomment it
...
//arrow this one is the answer but i dont want to uncomment it 
// declaration
// expression
...
//const nString = exclaimThree('shout')
//console.log(exclaimThree('gunk'));
...
function nameCheck(name){
  ...
  const nameGreeting = nameCheck('nate');
...
//CODE HERE
const thatsOdd = num1 => num1%2 === 0 ? "That's not odd!"  : "That is odd indeed";
...
//CODE HERE
const bestMovie = mTitle => `${mTitle} is the best movie ever!`
//console.log(bestMovie('Avengers'));
...
//CODE HERE
function theEliminator(contArr, nloser){
  for( i = 0; i < contArr.length; i++){
    if(contArr[i] === loser){
      contArr.splice(i, 1);
      let nContArr = contArr;
      return nContArr;
    }
  }
...
//upperString("Hi, my name is Kylo.")
...
function emailCheck(email){ 
  let nEmail = String(email);
  nEmail = nEmail.trim();
  return(nEmail.includes('@') ? 'email verified' : 'must provide a valid email address')
  }
//console.log(emailCheck('          jdfkjfd@example.com        ' ))
...
//CODE HERE
const goldForFrogs = function( gold ){
  let totalFrogs = 0;
  for( let i = gold; i > 0; i = i - 3){
     totalFrogs++;
  }
  return totalFrogs;
}

const totalFrogs = goldForFrogs(24);
...
//CODE HERE
const goldForFrogs2 = function( gold ){
  let totalFrogs = gold/3;
 return Math.floor(totalFrogs);
  //Math.floor(totalFrogs);
 // return totalFrogs;
}

const totalFrogs2 = goldForFrogs2(4);
//console.log(totalFrogs2);

////////////////// PROBLEM 21 ////////////////////
let sampleArray = [0,1,2,3,4,5,6,5,8,9]
/*
  Write a function that takes in an array of numbers as an argument. In the body of the function, write logic to determine if the array is in ascending order. The function should return true, if it is sorted in ascending order, false if it is not. Create a variable, `arrayIsAscending` and set it equal to your function invoked. Use the sample array to test this function.
*/

//CODE HERE
function isAscending( newArr){
  let ascendBoo = true;
